        ...
        methods = {
            ...
            hide    : function(options, callback, self){
                ...
                if(methods.isActive()){
                    ...
                    if(typeof(opts.content)!="string"){
                      opts.contentParent.append(opts.content);
                    }
                }
            },
            ...
            show    : function(options, callback, self){
                ...
                if(methods.isActive()){
                    ...
                    if(typeof(opts.content)!="string"){
                      opts.contentParent = opts.content.parent();
                      var toApp = opts.content.detach()
                      $f.find('#fallr').append(toApp);
                    }else{
                      $f.find('#fallr').html(opts.content);
                    }
                    
                    // re-initialize-chosen
                    $('select:not(.chzn-done):not(.no-chosen)').chosen();
